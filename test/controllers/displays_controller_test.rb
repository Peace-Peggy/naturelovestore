...
class DisplaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create display" do
    assert_difference('Display.count') do
      post displays_url, params: { display: { body: @display.body, title: @display.title, user_id: @display.user_id } }
    end
  ...
  test "should update display" do
    patch display_url(@display), params: { display: { body: @display.body, title: @display.title, user_id: @display.user_id } }
